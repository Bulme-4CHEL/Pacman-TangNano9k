...
// FIX: Replaced real arithmetic (* 1.1) with integer arithmetic (* 11 / 10)
localparam int CYCLE_TIME_STAMP_COUNTER_WIDTH = $clog2(CYCLE_TIME_STAMP_COUNTER_IDEAL * 11 / 10); 
